...
public abstract partial class Tiling<TTextureID>
{
    ...
    public class TileMesh : GameObject
    {
        ...
        public TileMesh(in Technique shader, in TileSet set, in TileMap map)
        {
                    ...
                    .Create(
                        new OpenGL.Descriptions.VertexArrayObjectDescription
                        {
                            Buffers = new()
                            {
                                ...
                                {
                                    VertexArrayBufferAttachmentType.AdditionalBuffer0,
                                    BufferObjectDescription.ArrayBuffer
                                }
                            }
                        }
            ...
            Vbo.VertexBuffer.SetLayout<BasicVertex>();
            ...
            Vbo.VertexBuffer.VertexAttributeDivisor(2, 1);
            Vbo.VertexBuffer.VertexAttributeDivisor(3, 1);
            Vbo.VertexBuffer.VertexAttributeDivisor(4, 1);
